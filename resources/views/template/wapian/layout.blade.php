	...
	<body class="@yield('body')">
					...
					<div class="item">
						<div class="logo">
							<a class="hidden-sm hidden-xs" href="/">
								<img src="/public/static/wapian/images/logo.png" height="50px" width="150px"/>
							</a>
						</div>
						<div class="search hidden-sm">
							<div id="ff-search" role="search">
								...
								<a href="javascript:" class="btns" title="搜索" id="sousuo">
		...
		<div class="hy-gototop hidden-sm hidden-xs">
			<ul class="item clearfix">
				<li>
					<a data-toggle="tooltip" data-placement="top" class="" href="javascript:scroll(0,0)" title="返回顶部">
		...
		<div class="tabbar visible-xs">
			...
			<a href="/tvlist/all/1.html" class="item ">
				<i class="icon iconfont icon-show"></i>
				<p class="text">
					电视剧
				</p>
			</a>
			<a href="/dmlist/all/1.html" class="item ">
				<i class="icon iconfont icon-mallanimation"></i>
				<p class="text">
					动漫
				</p>
			</a>
			<a href="/zylist/all/1.html" class="item ">
			...
			<div class="row">
				<div class="hy-footer clearfix">
					<p style="padding: 0 4px;text-align:center" class="container-fluid">
						本站提供影视资源来源于互联网,若有侵权，欢迎致信。
						<br/>
						管理员邮箱：{{config('webset.webmail')}}
						<br />
						Copyright:
						<a href="#" target="_blank">
							{{config('webset.webicp')}}-{{config('webset.copyright')}}
						</a>
						<br />
						<!--站长统计代码-->
