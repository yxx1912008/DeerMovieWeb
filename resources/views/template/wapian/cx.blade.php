	...
	<div class="row">
		<div class="hy-cascade clearfix">
			<div class="left-head hidden-sm hidden-xs">
				<ul class="clearfix">
					<li class="text">
						<span class="text-muted">当前频道</span>
					</li>
					<li>
						<a href="/cxlist.html"  class="active">
							尝鲜视频
						</a>
					</li>
				</ul>
						...
						<div class="item">
							...
							<div class="col-md-2 col-sm-3 col-xs-4">
								<a class="videopic lazy" href="/play/{{$key}}.html" title="{{$dy['dyname']}}" src="{{$dy['dylogo']}}" onclick="jilu(this)" style="background: url({{$dy['dylogo']}}) no-repeat; background-position:50% 50%; background-size: cover;">
									<span class="play hidden-xs"></span><span class="score"></span>
								</a>
								<div class="title">
									<h5 class="text-overflow">
									<a href="/play/{{$key}}.html" title="{{$dy['dyname']}}" src="{{$dy['dylogo']}}" onclick="jilu(this)">
										{{$dy['dyname']}}
									</a></h5>
								</div>
